<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	// 이 구문을 스크립틀릿이라고 부르며, html 문서 내에 자바 코드를 쓸 수 있는 영역
	// 현재 이 jsp에서 필요로 하는 데이터들 => request의 attribute 영역에 담겨있음
	// request.getAttribute("key") : Object(그에 해당하는 밸류 값의 자료형으로 형 변환해 줘야 함)
